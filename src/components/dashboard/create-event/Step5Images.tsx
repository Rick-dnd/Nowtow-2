...
export function Step5Images({ form }: StepComponentProps<EventFormValues>): React.ReactElement {
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold">Event-Bilder</h3>
        <p className="text-sm text-muted-foreground mt-1">
          Lade Bilder für dein Event hoch (optional)
        </p>
      </div>
