...
import { Calendar, MapPin, DollarSign, Users, Edit2 } from 'lucide-react';
...
export function Step5Review({ form }: StepComponentProps<EventFormValues>): React.ReactElement {
          ...
          <dl className="space-y-2 text-sm">
            <div className="flex items-center gap-4">
              <div className="flex-1">
                ...
                <dd className="font-medium">
                  {values.ticket_price === 0 ? 'Free' : `$${values.ticket_price}`}
                </dd>
              </div>
              <div className="flex-1">
